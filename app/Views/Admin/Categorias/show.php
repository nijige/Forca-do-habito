        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class=" card-text">
                    ...
                    <?php echo esc($categoria->ativo ? 'Sim' : 'Não'); ?>
                ...
                <?php if ($categoria->deletado_em == null) : ?>
                    ...
                    <a href="<?php echo site_url("admin/categorias/editar/$categoria->id");?>" class="btn btn-danger btn-sm mr-2">
                    <i class="mdi mdi-pencil btn-icon-prepend"> </i>
                      Excluir
                    ...
                    <a href="<?php echo site_url("admin/categorias/excluir/$categoria->id");?>" class="btn btn-light text-dark btn-sm">
                    <i class="mdi mdi-pencil btn-icon-prepend"> </i>
                      Voltar
                ...
                <?php else:?>
                    <a title="Desfazer exclusão" href="<?php echo site_url("admin/categorias/desfazerexclusao/$categoria->id");?>" class="btn btn-danger btn-sm mr-2">
                    <i class="mdi mdi-pencil btn-icon-prepend"> </i>
                      Desfazer
